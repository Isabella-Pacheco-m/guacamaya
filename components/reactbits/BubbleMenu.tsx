...
// BubbleMenu — header de burbujas con menú expandible. Adaptado de
// reactbits.dev (MIT). https://reactbits.dev/components/bubble-menu
...
export default function BubbleMenu({
  ...
  // Cerrar al navegar con un enlace del menú (anclas en la misma página).
  const closeMenu = () => {
    setIsMenuOpen(false)
  }
  ...
  return (
    <>
      {/* Reglas que Tailwind no puede expresar (nth-child, CSS vars en hover) */}
      <style>{`
